                    ...
                    <div className="col-md-6">
                        <div className="row">
                            ...
                            <div className="col-md-11">
                                ...
                                <p>
                                    Un processus structuré qui permet de traiter
                                    des situations telles que: anxiété,
                                    dépression, épuisement, problématiques
                                    relationnelles, difficultés d'adaptation...
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-11">
                                ...
                                <p>
                                    ...
                                    personnalités difficiles, maximiser votre
                                    influence, gagner en assurance et actualiser
                                    votre potentiel.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="col-md-6">
                        <div className="row">
                            ...
                            <div className="col-md-11">
                                ...
                                <p>
                                    Donnez vous les ressources pour aider le
                                    capital humain de votre entreprise à
